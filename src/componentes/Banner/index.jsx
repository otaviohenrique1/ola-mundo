  ...
  return (
    <div className={styles.banner}>
      ...
      <div className={styles.imagens}>
        <img src={circuloColorido} alt="circuloColorido" className={styles.circuloColorido} aria-hidden={true}/> 
        <img src={minhaFoto} alt="Minha Foto" className={styles.minhaFoto} />
      </div>
    </div>
  );
}